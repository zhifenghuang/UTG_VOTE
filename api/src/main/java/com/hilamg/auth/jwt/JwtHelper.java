...
import com.hilamg.common.constant.Constant;

import java.util.*;

public class JwtHelper {
	// 秘钥
//	static final String              = "X-Litemall-Token";
	// 签名是有谁生成
	...
	public static String createToken(Integer userId,String address){
		try {
		    Algorithm algorithm = Algorithm.HMAC256(Constant.TOKEN_SECRET);
		    Map<String, Object> map = new HashMap<String, Object>();
		    Date nowDate = new Date();
		    // 过期时间：2小时
		    Date expireDate = getAfterDate(nowDate,1,0,0,12,0,0);
	        map.put("alg", "HS256");
	        map.put("typ", "JWT");
	...
	public  static String verifyTokenAndGetPhone(String token) {
		try {
			Algorithm algorithm = Algorithm.HMAC256(Constant.TOKEN_SECRET);
			JWTVerifier verifier = JWT.require(algorithm)
					.withIssuer(ISSUSER)
